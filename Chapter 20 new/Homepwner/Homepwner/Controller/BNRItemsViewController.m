...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [self updateTableViewForDynamicType];
}
...
#pragma mark Dynamie type UIText

- (void)updateTableViewForDynamicType {
    ...
    if (!cellHeightDictionary) {
        cellHeightDictionary = @{
            ...
            @"UIContentSizeCategoryXL": @55,
            @"UIContentSizeCategoryXXL": @65,
            @"UICTContentSizeCategoryXXXL": @75,
        };
    }
